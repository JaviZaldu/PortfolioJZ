...
function Sidebar() {
  ...
  return (
    <div className={`${styles.sidebar} ${temaClaro ? '' : styles.darksidebar}`}>
         <ul className={styles.social}>
            <li className={styles['social-item']}>
                <a className={`${styles['social-link']} ${temaClaro ? '' : styles['darksocial-link']}`} href="https://www.linkedin.com/in/javier-zalduendo/" target="_blank" rel="noopener noreferrer">
            ...
            <li className={styles['social-item']}>
                <a className={`${styles['social-link']} ${temaClaro ? '' : styles['darksocial-link']}`} href="https://github.com/JaviZaldu" target="_blank" rel="noopener noreferrer">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className={styles['social-item']}>
                <a className={`${styles['social-link']} ${temaClaro ? '' : styles['darksocial-link']}`} href="mailto:javizaldu9@gmail.com" target="_blank" rel="noopener noreferrer">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className={styles['social-item']}>
                <a className={`${styles['social-link']} ${temaClaro ? '' : styles['darksocial-link']}`} href="https://instagram.com/javierzalduendo?igshid=YTQwZjQ0NmI0OA==" target="_blank" rel="noopener noreferrer">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
